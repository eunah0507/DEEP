package com.basic.deep.auth.oauth;
...
import static com.basic.deep.auth.Constants.SERVER_URL;
    ...
    KAKAO {
        ...
        public Builder getBuilder(String registrationId) {
            Builder builder = getBuilder(registrationId,
                    ClientAuthenticationMethod.CLIENT_SECRET_POST, SERVER_URL.concat("/deep/member/login/callback/{registrationId}"));
    ...
    GOOGLE {
        ...
        public Builder getBuilder(String registrationId) {
            ClientRegistration.Builder builder = getBuilder(registrationId,
                    ClientAuthenticationMethod.CLIENT_SECRET_BASIC, SERVER_URL.concat("/deep/member/login/callback/{registrationId}"));
